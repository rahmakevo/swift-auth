...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if #available(iOS 13, *) {
            // setup coordinator in the scene delegate
        } else {
    ...
    private func setUpCoordinator(_ application: UIApplication) {
        ...
        coordinator = MainViewCoordinator(navigationController: navController, completion: nil)
        coordinator?.start()
        window = nil
    ...
    lazy var persistentContainer: NSPersistentCloudKitContainer = {
        ...
        */
        let container = NSPersistentCloudKitContainer(name: "MVVM_C_Custom_App")
